...
if (e.which==2||e.which==3) { $('.alert').fadeIn(1000); $('.alert').effect("shake"); setTimeout(function(){ $('.alert').fadeOut(1000); }, 6000); return false;}}} 
if (document.layers) 
...
var snowStorm = (function(window, document) {
  ...
  this.vMaxX = 10;                 // Maximum X velocity range for snow
